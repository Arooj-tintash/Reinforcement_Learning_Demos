...
def saveFile(reward_sum, timestamps):
    np.savetxt("history/frostbite_keras_DQN/frostbite_rewards.txt",reward_sum, fmt= '%d')

    currentTime = calendar.timegm(time.gmtime())
    timestamps.append(currentTime)
    np.savetxt("history/frostbite_keras_DQN/frostbite_timestamps.txt",timestamps, fmt= '%d')

def loadFile():
    Rewards = np.loadtxt("history/frostbite_keras_DQN/frostbite_rewards.txt", dtype=int)
    timestamps = np.loadtxt("history/frostbite_keras_DQN/frostbite_timestamps.txt", dtype=int)
...
try:
    ...
    print('python3 frostbite_keras_DQN.py --train True --resume True --render False --graph True')
    sys.exit(2)
...
for opt, arg in opts:
    if opt == '-h':
        print('python3 frostbite_keras_DQN.py --train True --resume True --render False')
        sys.exit()
    elif opt in ("-t", "--train"):
        isTrain = arg
...
if isTrain == 'True':
    ...
    if demoChkpt == 0:
        filename = 'history/frostbite_keras_DQN/frostbite_dqn_weights.h5'
    else:
        filename = 'history/frostbite_keras_DQN/frostbite_dqn_weights_' + str(demoChkpt) + '.h5'
